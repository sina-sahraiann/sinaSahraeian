...
export const BentoGridItem = ({
  ...
  const rightLists = ["Redux", "Tailwind"];
  ...
  const handleCopy = () => {
    const text = "sinasahraeian780@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className=" font-extralight md:max-w-36 md:text-xs lg:text-base text-sm text-[#C1C2D3] z-10 text-nowrap">
            {description}
          </div>
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                title={copied ? dict.gridItemsButton.copied : dict.gridItemsButton.default}
