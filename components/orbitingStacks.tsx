...
export function OrbitingStacks() {
   return (
      <div className="absolute flex left-14 h-[500px] w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg md:shadow-xl">
         ...
         >
            {/* <Icons.whatsapp /> */}
            <img src="/next copy.svg" alt="icon5" className="size-10" />
         </OrbitingCircles>
         <OrbitingCircles
            className="h-[30px] w-[30px] border-none bg-transparent"
            duration={20}
            ...
            radius={80}
         >
            <img src="/re.svg" alt="icon5" className="size-10" />
         </OrbitingCircles>
         ...
         <OrbitingCircles
            ...
            delay={20}
         >
            <img src="/tail.svg" alt="icon5" className="size-10" />
         </OrbitingCircles>
         <OrbitingCircles
            className="h-[30px] w-[30px] border-none bg-transparent"
            reverse
         ...
         {/* <OrbitingCircles
            ...
            duration={20}
         >
            <img src="/shadcn.svg" alt="icon5" className="size-10 bg-white" />
         </OrbitingCircles> */}
